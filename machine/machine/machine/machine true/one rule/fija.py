...
def entrenar_con_valor_de_caracteristica(X, y_supervisado, caracteristica, valor):
 ...
 error = sum([contador_por_clase for valor_de_la_clase, contador_por_clase in
contadores_por_clase.items() if valor_de_la_clase != clase_mas_frecuente])
...
#print("El mejor model está basado en la variable {0} y tiene como error {1:.2f}".format(mejor_variable, mejor_error))
      
# Choose the bset model
modelo = {'variable': mejor_variable,
 'predictor': todos_los_predictores[mejor_variable][0]}
#print(modelo)
